...
public class AdminLyndasListMenu2 {

	public JFrame LyndaListDrinks;
	private int offsetX;
    private int offsetY;
	/**
	...
	private void initialize() {
		LyndaListDrinks = new JFrame();
		LyndaListDrinks.setUndecorated(true);
		LyndaListDrinks.setBounds(100, 100, 1401, 799);
		LyndaListDrinks.setLocationRelativeTo(null);
		LyndaListDrinks.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		LyndaListDrinks.getContentPane().setLayout(null);
		...
		JButton btnHistory = new JButton("");
		 btnHistory.setIcon(new ImageIcon(getClass().getResource("/Pictures/ORDER HISTORY.png")));
		   ...
		   LyndaListDrinks.getContentPane().add(btnHistory);
        ...
        LyndaListDrinks.getContentPane().add(clockPanel);
        ...
        LyndaListDrinks.getContentPane().add(btnSnacks);
        ...
        LyndaListDrinks.getContentPane().add(btnSoda);
     ...
     // Ulam Button
        ...
        btnUlam.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null)); // Set initial line border
        LyndaListDrinks.getContentPane().add(btnUlam);
        ...
        btnUlam.addMouseListener(new MouseAdapter() {
		   ...
		   JButton btnLogOut = new JButton("");
	        ...
	        LyndaListDrinks.getContentPane().add(btnLogOut);
	        ...
	        btnDish8.setIcon(new ImageIcon (getClass().getResource("/Pictures/LyndasAdmin Water.png")));
	        btnDish8.setBounds(894, 468, 170, 180);
	        LyndaListDrinks.getContentPane().add(btnDish8);
	        ...
	        btnDish7.addActionListener(new ActionListener() {
	        	public void actionPerformed(ActionEvent e) {
	        	}
	        });
	        btnDish7.setBackground(Color.WHITE);
	        btnDish7.setIcon(new ImageIcon (getClass().getResource("/Pictures/LyndasAdmin Gatorade.png")));
	        btnDish7.setBounds(709, 468, 170, 180);
	        LyndaListDrinks.getContentPane().add(btnDish7);
	        btnDish7.addMouseListener(new java.awt.event.MouseAdapter() {
			    ...
			    public void mouseClicked(java.awt.event.MouseEvent evt) {
	                showEditDialog("Gatorade");
	                FileOperation.copyFile("src/data/LyndasMenu1.txt","src/data/LyndasMenu2.txt" );
	            }
	        });
	        JButton btnDish6 = new JButton("");
	        btnDish6.setBackground(Color.WHITE);
	        btnDish6.setIcon(new ImageIcon (getClass().getResource("/Pictures/LyndasAdmin Zesto Juice.png")));
	        btnDish6.setBounds(523, 469, 170, 180);
	        LyndaListDrinks.getContentPane().add(btnDish6);
	        btnDish6.addMouseListener(new java.awt.event.MouseAdapter() {
			    ...
			    public void mouseClicked(java.awt.event.MouseEvent evt) {
	                showEditDialog("ZestoBig");
	                FileOperation.copyFile("src/data/LyndasMenu1.txt","src/data/LyndasMenu2.txt" );
	            }
	        });
	        JButton btnDish5 = new JButton("");
	        btnDish5.setBackground(Color.WHITE);
	        btnDish5.setIcon(new ImageIcon (getClass().getResource("/Pictures/LyndasAdmin Nestea.png")));
	        btnDish5.setBounds(337, 468, 170, 180);
	        LyndaListDrinks.getContentPane().add(btnDish5);
	        btnDish5.addMouseListener(new MouseAdapter() {
	        	...
	        	public void mouseClicked(java.awt.event.MouseEvent evt) {
	                showEditDialog("Nestea");
	                FileOperation.copyFile("src/data/LyndasMenu1.txt","src/data/LyndasMenu2.txt" );
	            }
	        });
	        
	        JButton btnDish4 = new JButton("");
	        btnDish4.addActionListener(new ActionListener() {
	        	public void actionPerformed(ActionEvent e) {
	        	}
	        });
	        btnDish4.setBackground(Color.WHITE);
	        btnDish4.setIcon(new ImageIcon (getClass().getResource("/Pictures/LyndasAdmin Coffee.png")));
	        btnDish4.setBounds(894, 275, 170, 180);
	        LyndaListDrinks.getContentPane().add(btnDish4);
	        ...
	        btnDish3.setIcon(new ImageIcon (getClass().getResource("/Pictures/LyndasAdmin Sprite.png")));
	        btnDish3.setBounds(709, 275, 170, 180);
	        LyndaListDrinks.getContentPane().add(btnDish3);
	        ...
	        btnDish2.setIcon(new ImageIcon (getClass().getResource("/Pictures/LyndasAdmin Coke.png")));
	        btnDish2.setBounds(523, 275, 170, 180);
	        LyndaListDrinks.getContentPane().add(btnDish2);
	        ...
	        btnDish1.setIcon(new ImageIcon (getClass().getResource("/Pictures/LyndasAdmin Mountain Dew.png")));
	        btnDish1.setBounds(337, 275, 170, 180);
	       
	        LyndaListDrinks.getContentPane().add(btnDish1);
		...
		LyndaListDrinks.setShape(new RoundRectangle2D.Double(0, 0, LyndaListDrinks.getWidth(), LyndaListDrinks.getHeight(), 100, 100));
		LyndaListDrinks.getContentPane().add(lblDesign);
		...
		lblDesign.addMouseMotionListener(new MouseAdapter() {
            ...
            public void mouseDragged(MouseEvent e) {
                ...
                LyndaListDrinks.setLocation(x, y);
            }
        });
		loadDishQuantities();
	}
	...
	private void showEditDialog(String dishName) {
	    ...
	    if (currentQuantity != null) {
	        ...
	        String newQuantityStr = JOptionPane.showInputDialog(LyndaListDrinks, message, currentQuantity + "," + currentPrice);
	        if (newQuantityStr != null) {
	            try {
	                ...
	                if (parts.length == 2) {
	                    ...
	                    saveDishQuantities();
	                    JOptionPane.showMessageDialog(LyndaListDrinks, "Quantity and price updated successfully!");
	                } else {
	                    throw new NumberFormatException();
	                }
	            } catch (NumberFormatException e) {
	                JOptionPane.showMessageDialog(LyndaListDrinks, "Invalid input format! Please enter quantity and price separated by a comma (e.g., 10,5.99).");
	            }
	        }
	    } else {
	        JOptionPane.showMessageDialog(LyndaListDrinks, "Dish not found!");
	    }
	}
