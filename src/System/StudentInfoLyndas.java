...
public class StudentInfoLyndas   {
        ...
        getInfoButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    BufferedWriter writer = new BufferedWriter(new FileWriter("src/data/LyndasHistory.txt", true));
    ...
    private void getInfoButtonClicked() {
        ...
        if (name.isEmpty()&& mobile.isEmpty()) {
        	...
        	ReceiptLyndas receiptWindow = new ReceiptLyndas();
    ...
    String	historyPath = "src/data/LyndasHistory.txt";
